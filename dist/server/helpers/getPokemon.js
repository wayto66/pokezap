...
const getPokemonRequestData_1 = require("./getPokemonRequestData");
const getPokemon = (prismaClient, pokemonIdString, playerId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield prismaClient.pokemon.findFirst({
