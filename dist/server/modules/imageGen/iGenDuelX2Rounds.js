...
exports.iGenDuelX2Rounds = void 0;
...
const iGenDuelX2Rounds = (data) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return __awaiter(this, void 0, void 0, function* () {
              ...
              await drawTalents(leftPokemon1Talents, 5, 400) */
                ...
                for (let i = 0; i < totalBattleFrames; i++) {
                    ...
                    ctx.textAlign = 'start';
                    if (i % 6 !== 0) {
                        ctx.fillText((_a = roundInfo.leftTeamData[0].currentSkillName) !== null && _a !== void 0 ? _a : '', 15, 411);
                        ctx.fillText((_b = roundInfo.leftTeamData[1].currentSkillName) !== null && _b !== void 0 ? _b : '', 15, 477);
                        ctx.fillText((_c = roundInfo.rightTeamData[0].currentSkillName) !== null && _c !== void 0 ? _c : '', 315, 411);
                        ctx.fillText((_d = roundInfo.rightTeamData[1].currentSkillName) !== null && _d !== void 0 ? _d : '', 315, 477);
                    }
                    // draw skill types
                    const leftFlag0 = skillFlagImagesMap.get((_e = roundInfo.leftTeamData[0].currentSkillType) !== null && _e !== void 0 ? _e : '');
                    if (leftFlag0)
                        ctx.drawImage(leftFlag0, 131, 393, 75, 25);
                    const leftFlag1 = skillFlagImagesMap.get((_f = roundInfo.leftTeamData[1].currentSkillType) !== null && _f !== void 0 ? _f : '');
                    if (leftFlag1)
                        ctx.drawImage(leftFlag1, 131, 451, 75, 25);
                    const rightFlag0 = skillFlagImagesMap.get((_g = roundInfo.rightTeamData[0].currentSkillType) !== null && _g !== void 0 ? _g : '');
                    if (rightFlag0)
                        ctx.drawImage(rightFlag0, 421, 393, 75, 25);
                    const rightFlag1 = skillFlagImagesMap.get((_h = roundInfo.rightTeamData[1].currentSkillType) !== null && _h !== void 0 ? _h : '');
                    if (rightFlag1)
...
exports.iGenDuelX2Rounds = iGenDuelX2Rounds;
//# sourceMappingURL=iGenDuelX2Rounds.js.map