...
exports.iGenDuel2X1Rounds = void 0;
...
const iGenDuel2X1Rounds = (data) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (let i = 0; i < data.roundCount * framesPerRound + 12; i++) {
                    ...
                    canvas.write({
                        ...
                        positionX: 315,
                        positionY: 425,
                        text: (_c = roundInfo.rightTeamData[0].currentSkillName) !== null && _c !== void 0 ? _c : '',
                    });
                    // draw skill types
                    if (i % 6 !== 0) {
                        const bossSkillFlag = skillFlagImagesMap.get((_d = roundInfo.rightTeamData[0].currentSkillType) !== null && _d !== void 0 ? _d : '');
                        if (bossSkillFlag)
                            canvas.draw({
                                positionX: 421,
                                positionY: 405,
                        ...
                        for (let i = 0; i < roundInfo.leftTeamData.length; i++) {
                            const skillFlag = skillFlagImagesMap.get((_e = roundInfo.leftTeamData[i].currentSkillType) !== null && _e !== void 0 ? _e : '');
                            if (skillFlag) {
                                canvas.draw({
                                    positionX: 131,
                                    positionY: 390 + i * 50,
...
exports.iGenDuel2X1Rounds = iGenDuel2X1Rounds;
//# sourceMappingURL=iGenDuel2X1Rounds.js.map