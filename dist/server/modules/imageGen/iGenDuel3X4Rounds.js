...
exports.iGenDuel3X4Rounds = void 0;
...
const iGenDuel3X4Rounds = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const filepath = yield new Promise(resolve => {
        function processCode() {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            return __awaiter(this, void 0, void 0, function* () {
                const { leftTeam, rightTeam, backgroundTypeName } = data;
                const hudUrl = './src/assets/sprites/UI/hud/duel_3x4_round.png';
                ...
                // load poke3 sprite
                const rightPokeSprite2 = yield (0, loadOrSaveImageFromCache_1.loadOrSaveImageFromCache)(rightTeam[2].spriteUrl);
                // load poke4 sprite
                yield (0, loadOrSaveImageFromCache_1.loadOrSaveImageFromCache)(rightTeam[3].spriteUrl);
                ...
                const drawStillPart = (roundInfo) => {
                    ...
                    if (roundInfo.rightTeamData[2].hp > 0)
                        canvas.draw({
                            height: 251,
                            width: 251,
                            positionX: 240,
                            positionY: 95,
                            image: rightPokeSprite2,
                        });
                    if (roundInfo.rightTeamData[3].hp > 0)
                        canvas.draw({
                            height: 251,
                            width: 251,
                            positionX: 360,
                    ...
                    // right team
                    canvas.write(Object.assign(Object.assign({}, nameLevelDefaults), { positionX: 325, positionY: 35, textAlign: 'start', text: rightTeam[0].name }));
                    canvas.write(Object.assign(Object.assign({}, nameLevelDefaults), { positionX: 495, positionY: 35, textAlign: 'start', text: rightTeam[0].level.toString() }));
                    canvas.write(Object.assign(Object.assign({}, nameLevelDefaults), { positionX: 325, positionY: 85, textAlign: 'start', text: rightTeam[1].name }));
                    canvas.write(Object.assign(Object.assign({}, nameLevelDefaults), { positionX: 495, positionY: 85, textAlign: 'start', text: rightTeam[1].level.toString() }));
                    canvas.write(Object.assign(Object.assign({}, nameLevelDefaults), { positionX: 325, positionY: 135, textAlign: 'start', text: rightTeam[2].name }));
                    canvas.write(Object.assign(Object.assign({}, nameLevelDefaults), { positionX: 495, positionY: 135, textAlign: 'start', text: rightTeam[2].level.toString() }));
                    canvas.write(Object.assign(Object.assign({}, nameLevelDefaults), { positionX: 325, positionY: 5, textAlign: 'start', text: rightTeam[3].name }));
                    canvas.write(Object.assign(Object.assign({}, nameLevelDefaults), { positionX: 495, positionY: 5, textAlign: 'start', text: rightTeam[3].level.toString() }));
                    // end
                };
                ...
                for (let i = 0; i < data.roundCount * framesPerRound + 12; i++) {
                    ...
                    canvas.fillRect(Object.assign(Object.assign({}, rightHpDefaults), { y: 7, w: Math.max(0, (roundInfo.rightTeamData[0].hp / roundInfo.rightTeamData[0].maxHp) * 125) }));
                    ...
                    canvas.fillRect(Object.assign(Object.assign({}, rightHpDefaults), { y: 107, w: Math.max(0, (roundInfo.rightTeamData[2].hp / roundInfo.rightTeamData[2].maxHp) * 125) }));
                    canvas.fillRect(Object.assign(Object.assign({}, rightHpDefaults), { y: 155, w: Math.max(0, (roundInfo.rightTeamData[3].hp / roundInfo.rightTeamData[3].maxHp) * 125) }));
                    // draw mana
                    ...
                    canvas.fillRect(Object.assign(Object.assign({}, rightManaDefaults), { y: 15, w: Math.max(0, (roundInfo.rightTeamData[0].mana / 100) * 175) }));
                    canvas.fillRect(Object.assign(Object.assign({}, rightManaDefaults), { y: 65, w: Math.max(0, (roundInfo.rightTeamData[1].mana / 100) * 175) }));
                    canvas.fillRect(Object.assign(Object.assign({}, rightManaDefaults), { y: 110, w: Math.max(0, (roundInfo.rightTeamData[2].mana / 100) * 175) }));
                    canvas.fillRect(Object.assign(Object.assign({}, rightManaDefaults), { y: 160, w: Math.max(0, (roundInfo.rightTeamData[3].mana / 100) * 175) }));
                    ...
                    canvas.write(Object.assign(Object.assign({}, rightTeamSkillNameDefaults), { positionY: 325, text: (_d = roundInfo.rightTeamData[0].currentSkillName) !== null && _d !== void 0 ? _d : '' }));
                    canvas.write(Object.assign(Object.assign({}, rightTeamSkillNameDefaults), { positionY: 375, text: (_e = roundInfo.rightTeamData[1].currentSkillName) !== null && _e !== void 0 ? _e : '' }));
                    canvas.write(Object.assign(Object.assign({}, rightTeamSkillNameDefaults), { positionY: 425, text: (_f = roundInfo.rightTeamData[2].currentSkillName) !== null && _f !== void 0 ? _f : '' }));
                    canvas.write(Object.assign(Object.assign({}, rightTeamSkillNameDefaults), { positionY: 475, text: (_g = roundInfo.rightTeamData[3].currentSkillName) !== null && _g !== void 0 ? _g : '' }));
                    // draw skill types
                    if (i % 6 !== 0) {
                        for (let i = 0; i < roundInfo.leftTeamData.length; i++) {
                            const skillFlag = skillFlagImagesMap.get((_h = roundInfo.leftTeamData[i].currentSkillType) !== null && _h !== void 0 ? _h : '');
                            if (skillFlag) {
                                canvas.draw({
                                    positionX: 131,
                                    positionY: 312 + i * 35,
                        ...
                        for (let i = 0; i < roundInfo.rightTeamData.length; i++) {
                            const skillFlag = skillFlagImagesMap.get((_j = roundInfo.rightTeamData[i].currentSkillType) !== null && _j !== void 0 ? _j : '');
                            if (skillFlag) {
                                canvas.draw({
                                    positionX: 421,
                                    positionY: 312 + i * 35,
...
exports.iGenDuel3X4Rounds = iGenDuel3X4Rounds;
//# sourceMappingURL=iGenDuel3X4Rounds.js.map