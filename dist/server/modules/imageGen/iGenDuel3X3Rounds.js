...
exports.iGenDuel3X3Rounds = void 0;
...
const iGenDuel3X3Rounds = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const filepath = yield new Promise(resolve => {
        function processCode() {
            var _a, _b, _c, _d, _e, _f, _g, _h;
            return __awaiter(this, void 0, void 0, function* () {
                const { leftTeam, rightTeam, backgroundTypeName } = data;
                const hudUrl = './src/assets/sprites/UI/hud/duel_3x3_round.png';
                ...
                const drawStillPart = (roundInfo) => {
                    ...
                    canvas.write(Object.assign(Object.assign({}, nameLevelDefaults), { positionX: 495, positionY: 35, textAlign: 'end', text: rightTeam[0].level.toString() }));
                    ...
                    canvas.write(Object.assign(Object.assign({}, nameLevelDefaults), { positionX: 495, positionY: 85, textAlign: 'end', text: rightTeam[1].level.toString() }));
                    ...
                    canvas.write(Object.assign(Object.assign({}, nameLevelDefaults), { positionX: 495, positionY: 135, textAlign: 'end', text: rightTeam[2].level.toString() }));
                    // end
                };
                ...
                for (let i = 0; i < data.roundCount * framesPerRound + 12; i++) {
                    ...
                    canvas.fillRect(Object.assign(Object.assign({}, rightManaDefaults), { y: 50, w: Math.max(0, (roundInfo.rightTeamData[0].mana / 100) * 175) }));
                    canvas.fillRect(Object.assign(Object.assign({}, rightManaDefaults), { y: 100, w: Math.max(0, (roundInfo.rightTeamData[1].mana / 100) * 175) }));
                    canvas.fillRect(Object.assign(Object.assign({}, rightManaDefaults), { y: 145, w: Math.max(0, (roundInfo.rightTeamData[2].mana / 100) * 175) }));
                    ...
                    canvas.write(Object.assign(Object.assign({}, rightTeamSkillNameDefaults), { positionY: 375, text: (_d = roundInfo.rightTeamData[0].currentSkillName) !== null && _d !== void 0 ? _d : '' }));
                    canvas.write(Object.assign(Object.assign({}, rightTeamSkillNameDefaults), { positionY: 425, text: (_e = roundInfo.rightTeamData[1].currentSkillName) !== null && _e !== void 0 ? _e : '' }));
                    canvas.write(Object.assign(Object.assign({}, rightTeamSkillNameDefaults), { positionY: 475, text: (_f = roundInfo.rightTeamData[2].currentSkillName) !== null && _f !== void 0 ? _f : '' }));
                    // draw skill types
                    if (i % 6 !== 0) {
                        for (let i = 0; i < roundInfo.leftTeamData.length; i++) {
                            const skillFlag = skillFlagImagesMap.get((_g = roundInfo.leftTeamData[i].currentSkillType) !== null && _g !== void 0 ? _g : '');
                            if (skillFlag) {
                                canvas.draw({
                                    positionX: 131,
                                    positionY: 362 + i * 50,
                        ...
                        for (let i = 0; i < roundInfo.rightTeamData.length; i++) {
                            const skillFlag = skillFlagImagesMap.get((_h = roundInfo.rightTeamData[i].currentSkillType) !== null && _h !== void 0 ? _h : '');
                            if (skillFlag) {
                                canvas.draw({
                                    positionX: 421,
                                    positionY: 362 + i * 50,
...
exports.iGenDuel3X3Rounds = iGenDuel3X3Rounds;
//# sourceMappingURL=iGenDuel3X3Rounds.js.map