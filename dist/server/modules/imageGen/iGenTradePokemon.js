...
exports.iGenTradePokemon = void 0;
...
const iGenTradePokemon = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const generatePoke1 = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const talents = [
            talentIdMap_1.talentIdMap.get(data.pokemon1.talentId1),
            talentIdMap_1.talentIdMap.get(data.pokemon1.talentId2),
            talentIdMap_1.talentIdMap.get(data.pokemon1.talentId3),
            talentIdMap_1.talentIdMap.get(data.pokemon1.talentId4),
            talentIdMap_1.talentIdMap.get(data.pokemon1.talentId5),
            talentIdMap_1.talentIdMap.get(data.pokemon1.talentId6),
            talentIdMap_1.talentIdMap.get(data.pokemon1.talentId7),
            talentIdMap_1.talentIdMap.get(data.pokemon1.talentId8),
            talentIdMap_1.talentIdMap.get(data.pokemon1.talentId9),
        ];
        ctx.globalAlpha = 1;
        for (let i = 0; i < 3; i++) {
            for (let j = 0; j < 3; j++) {
    ...
    const generatePoke2 = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const talents = [
            talentIdMap_1.talentIdMap.get(data.pokemon2.talentId1),
            talentIdMap_1.talentIdMap.get(data.pokemon2.talentId2),
            talentIdMap_1.talentIdMap.get(data.pokemon2.talentId3),
            talentIdMap_1.talentIdMap.get(data.pokemon2.talentId4),
            talentIdMap_1.talentIdMap.get(data.pokemon2.talentId5),
            talentIdMap_1.talentIdMap.get(data.pokemon2.talentId6),
            talentIdMap_1.talentIdMap.get(data.pokemon2.talentId7),
            talentIdMap_1.talentIdMap.get(data.pokemon2.talentId8),
            talentIdMap_1.talentIdMap.get(data.pokemon2.talentId9),
        ];
        ctx.globalAlpha = 1;
        for (let i = 0; i < 3; i++) {
            for (let j = 0; j < 3; j++) {
...
exports.iGenTradePokemon = iGenTradePokemon;
//# sourceMappingURL=iGenTradePokemon.js.map