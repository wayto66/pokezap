...
const iGenDuel3X2Rounds_1 = require("../imageGen/iGenDuel3X2Rounds");
const iGenDuel3X3Rounds_1 = require("../imageGen/iGenDuel3X3Rounds");
const iGenDuel3X4Rounds_1 = require("../imageGen/iGenDuel3X4Rounds");
...
const duelNXN = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const leftPlayersPokeTeamsData = yield prisma.player.findMany({
        where: {
            id: {
                in: leftPlayerIds,
            },
    ...
    while (duelFinished === false) {
        ...
        const tank = (pokemon, allies, enemies) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (currentSkillData.skill.category === 'damage+heal') {
                for (const target of currentSkillData.targets) {
                    const pwrWithADRatio = (pokemon.currentSkillPower * adRatio(currentSkillData.skill, pokemon, target)) / 50;
                    const pwrDividedByTargets = pwrWithADRatio / currentSkillData.targets.length;
                    if (!target.block) {
                        target.hp -= pwrDividedByTargets * (0.9 + Math.random() * 0.2) * (1 - target.damageResistance);
                        pokemon.hp +=
        ...
        const handleRoundActions = ({ poke, forceAttack }) => __awaiter(void 0, void 0, void 0, function* () {
            if (poke.hp <= 0)
                return;
...
const getBestSkills = ({ attacker, defenders }) => __awaiter(void 0, void 0, void 0, function* () {
    var _k;
    ...
    for (const skill of skills) {
        ...
        const talentBonus = (_k = talentPowerBonusMap_1.talentPowerBonusMap.get(talentCheck.count)) !== null && _k !== void 0 ? _k : 0;
...
//# sourceMappingURL=duelNXN.js.map