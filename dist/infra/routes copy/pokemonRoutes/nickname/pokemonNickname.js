...
const pokemonNickname = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const nicknameCheck = yield prismaClient.basePokemon.findFirst({
        where: {
            name: nickname,
        },
    });
    ...
    const nicknameCheck2 = yield prismaClient.pokemon.findFirst({
        where: {
            nickName: nickname,
        },
    });
...
//# sourceMappingURL=pokemonNickname.js.map