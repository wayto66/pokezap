...
const cassinoTrade = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const player = (_a = data.player) !== null && _a !== void 0 ? _a : (yield prismaClient.player.findFirst({
        where: {
    ...
    const possibleRewardItems = yield prismaClient.baseItem.findMany({
        where: {
            npcPrice: {
    ...
    yield prismaClient.item.upsert({
        where: {
            ownerId_name: {
                ownerId: player.id,
...
//# sourceMappingURL=casinoTrade.js.map