...
const daycareOut = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (hoursLeft > 0)
        throw new AppErrors_1.PokemonInDaycare_RemainingTime(pokemon.id, pokemon.baseData.name, hoursLeft.toFixed(2));
    const targetLevel = Math.ceil(route.level / 2);
    const updatedPokemon = yield (0, handleLevelSet_1.handleLevelSet)({
        pokemon,
        targetLevel,
...
//# sourceMappingURL=daycareOut.js.map