...
const duelAcceptX2 = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!session.creator.teamPoke2)
        throw new AppErrors_1.PlayerDoesNotHaveThePokemonInTheTeamError(session.creator.name);
    if (!session.invited.teamPoke2)
        throw new AppErrors_1.PlayerDoesNotHaveThePokemonInTheTeamError(session.invited.name);
    ...
    let handleWinExp0;
    let handleWinExp1;
    if (loserPokemon0.level - winnerPokemon0.level > 15 ||
        ...
        handleLoseExp0 = yield (0, handleExperienceGain_1.handleExperienceGain)({
            pokemon: loserPokemon0,
            targetPokemon: winnerPokemon0,
        });
        handleLoseExp1 = yield (0, handleExperienceGain_1.handleExperienceGain)({
            pokemon: loserPokemon1,
            targetPokemon: winnerPokemon1,
        });
        handleWinExp0 = yield (0, handleExperienceGain_1.handleExperienceGain)({
            pokemon: winnerPokemon0,
            targetPokemon: loserPokemon0,
        });
        handleWinExp1 = yield (0, handleExperienceGain_1.handleExperienceGain)({
...
exports.duelAcceptX2 = duelAcceptX2;
//# sourceMappingURL=duelAcceptX2.js.map