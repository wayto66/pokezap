...
exports.duelX2Route = void 0;
const tsyringe_1 = require("tsyringe");
const iGenDuelX2_1 = require("../../../server/modules/imageGen/iGenDuelX2");
const AppErrors_1 = require("../../errors/AppErrors");
const duelX2Route = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    😂 - Batalha Vídeo`,
        ...
        imageUrl: imageUrl,
        actions: [
            `pz. duel acceptx2 ${newSession.id} fast`,
            `pz. duel acceptx2 ${newSession.id} fast`,
            `pz. duel acceptx2 ${newSession.id}`,
        ],
    };
});
exports.duelX2Route = duelX2Route;
//# sourceMappingURL=duelX2Route.js.map