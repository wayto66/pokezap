...
exports.duelX1Route = void 0;
const tsyringe_1 = require("tsyringe");
const AppErrors_1 = require("../../../infra/errors/AppErrors");
const iGenDuelX1_1 = require("../../../server/modules/imageGen/iGenDuelX1");
const duelX1Route = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const imageUrl = yield (0, iGenDuelX1_1.iGenDuelX1)({
        player1: player1,
        player2: player2,
    });
    return {
...
exports.duelX1Route = duelX1Route;
//# sourceMappingURL=duelX1Route.js.map