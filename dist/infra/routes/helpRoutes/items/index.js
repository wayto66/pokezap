...
exports.pokeBallBox = exports.tm = exports.propCase = exports.tmCase = exports.rareCandy = void 0;
exports.rareCandy = `📖 PokeZap Wiki - *RARE-CANDY* - [d] 
Avança o Pokemon para o próximo nível

Para usar: pz. useitem rare-candy id-do-pokemon`;
exports.tmCase = `📖 PokeZap Wiki - *TM-CASE* - [d] 
Pode conter até 3 TMs.

Para abrir: pz. useitem tm-case`;
exports.propCase = `📖 PokeZap Wiki - *PROP-CASE* - [d] 
Contém um held-item aleatório de nível 1 ou 2.

Para abrir: pz. useitem prop-case`;
exports.tm = `📖 PokeZap Wiki - *TM* - [d] 
...
exports.pokeBallBox = `📖 PokeZap Wiki - *POKEBALL-BOX* - [d] 
