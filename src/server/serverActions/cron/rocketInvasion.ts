...
import { iGenRocketInvasion } from '../../modules/imageGen/iGenRocketInvasion'
import { generateWildPokemon } from '../../modules/pokemon/generate/generateWildPokemon'

export const rocketInvasion = async (zapClient: Client) => {
  ...
  for (const gameRoom of gameRooms) {
    ...
    const result = await zapClient.sendMessage(gameRoom.phone, media, {
