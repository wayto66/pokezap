...
export const iGenDuelX2 = async (data: TParams) => {
  if (!data.player1.teamPoke1 || !data.player1.teamPoke2) throw new UnexpectedError('igenduelx2 teampoke player1')
  if (!data.player2.teamPoke1 || !data.player2.teamPoke2) throw new UnexpectedError('igenduelx2 teampoke player2')
